...
/* Changed forward declaration to just declaration,
...
class CConnection
{
  public:
    ...
    // added methods and variables to accept incoming connection
	int acceptConnection();
	// ---------------------------------------------------------

  //private:
  protected: // modified access privilege for the derived classes - shheo
	// added variables to accept incoming connection - shheo
	char *m_portNumStr;
	LLRP::CPlatformSocket *m_pPlatformSocket_listen;
	int m_isInitiatedConnection;
	// -----------------------------------------------------
  ...
  //private:
  protected: // modified access for the derived classes - shheo
    EResultCode
    recvAdvance (
      int                           nMaxMS,
      time_t                        timeLimit);
